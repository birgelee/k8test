...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in getid_pb2_grpc.py depends on'
...
def add_InformationServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('getid.Information', rpc_method_handlers)
...
class Information(object):
    ...
    def RequestID(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/getid.Information/RequestID',
            getid__pb2.IDRequest.SerializeToString,
